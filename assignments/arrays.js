...
// ==== Challenge 1 ====
console.log(`The dealer can't recall the information for a car with an id of 33 on his lot. Help the dealer find out which car has an id of 33 by logging the car's year, make, and model in the console log provided to you below:`);
let c = inventory.filter(x => x.id == 33);
console.log(`Car 33 is a ` + c[0].car_year + ` ` + c[0].car_make + ` ` + c[0].car_model);
...
let carYears = inventory.map(x => x.car_year).sort();
console.log(carYears);

// ==== Challenge 5 ====
console.log(`\nThe car lot manager needs to find out how many cars are older than the year 2000. Using the carYears array you just created, find out how many cars were made before the year 2000 by populating the array oldCars and logging it's length.`);
let oldCars = inventory.map(x => x.car_year).filter(y => y < 2000);
